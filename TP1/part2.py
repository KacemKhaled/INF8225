...
for lr in lrs:
  for minibatch_size in minibatch_sizes:
    ...
    losses_train, losses_val, best_theta, best_accuracy, accuracy_on_unseen_data = fit(X_train,y_train,lr,minibatch_size)
    ...
    plt.show()
print('\n\nChosen Test #{} based on the best accuracy on validation data\n\
Accuracy on Validation data= {:.10f}\n\
Accuracy on Test data= {:.10f}\n\
Chosen learning rate = {}\n\
Chosen minibatch size = {}\n'.format(chosen_test,chosen_accuracy,chosen_test_accuracy,chosen_lr,chosen_minibatch_size))
